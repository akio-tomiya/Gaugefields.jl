#=
module Gaugefields_2D_wing_module
    using LinearAlgebra
...
=#
    ...
    struct Gaugefields_2D_wing{NC} <: Gaugefields_2D{NC}
    ...
    function Base.setindex!(x::Gaugefields_2D_wing,v,i1,i2,i3,i6) 
        @inbounds x.U[i1,i2,i3 + x.NDW,i6 + x.NDW] = v
    end

    @inline function Base.getindex(x::Gaugefields_2D_wing,i1,i2,i3,i6) 
        @inbounds return x.U[i1,i2,i3 .+ x.NDW,i6 .+ x.NDW]
    end
    ...
    @inline function Base.getindex(U::Adjoint_Gaugefields{T},i1,i2,i3,i6) where T <: Abstractfields #U'
        @inbounds return conj(U.parent[i2,i1,i3,i6])
    end

    function Base.setindex!(U::Adjoint_Gaugefields{T},v,i1,i2,i3,i6,μ)  where T <: Abstractfields
    ...
    function substitute_U!(a::Array{T1,1},b::Array{T2,1},iseven) where {T1 <: Gaugefields_2D_wing,T2 <: Gaugefields_2D_wing}
        for μ=1:2
    ...
    function Base.similar(U::Array{T,1}) where T <: Gaugefields_2D_wing
    ...
    function substitute_U!(a::T,b::T) where T <: Gaugefields_2D_wing
        for i=1:length(a.U)
            a.U[i] = b.U[i]
        end
        return 
    ...
    function substitute_U!(a::Gaugefields_2D_wing{NC},b::T2) where {NC, T2 <: Abstractfields}
        NT = a.NT
        #NZ = a.NZ
        #NY = a.NY
        NX = a.NX
    ...
    function substitute_U!(a::Gaugefields_2D_wing{NC},b::T2,iseven::Bool) where {NC, T2 <: Abstractfields}
        NT = a.NT
        #NZ = a.NZ
        #NY = a.NY
        NX = a.NX
    ...
    function m3complv!(a::T) where T <: Gaugefields_2D_wing
        aa = zeros(Float64,18)
        NX = a.NX
        #NY = a.NY
        #NZ = a.NZ
    ...
    struct Shifted_Gaugefields_2D{NC,outside} <: Shifted_Gaugefields{NC,2} 
        parent::Gaugefields_2D_wing{NC}
        #parent::T
        shift::NTuple{2,Int8}
        NX::Int64
        #NY::Int64
        ...
        function Shifted_Gaugefields_2D(U::Gaugefields_2D_wing{NC},shift) where NC
            outside = check_outside(U.NDW,shift)
            return new{NC,outside}(U,shift,U.NX,U.NT,U.NDW)
        end
    end
    ...
    function check_outside(NDW,shift::Tuple{<:Any,<:Any}) 
        ...
        #lattice shift
    function shift_U(U::Gaugefields_2D_wing{NC},ν::T) where {T <: Integer,NC}
            if ν == 1
                shift = (1,0)
            elseif ν == 2
                shift = (0,1)
            ...
            return Shifted_Gaugefields_2D(U,shift)
    end
    
    function shift_U(U::TU,shift::NTuple{Dim,T}) where {Dim,T <: Integer,TU <: Gaugefields_2D}
        return Shifted_Gaugefields_2D(U,shift)
    end



    #function Base.setindex!(U::Shifted_Gaugefields{T,4},v,i1,i2,i3,i4,i5,i6)  where T <: Gaugefields_2D_wing
    function Base.setindex!(U::Shifted_Gaugefields{NC,2},v,i1,i2,i3,i6)  where NC
        error("type $(typeof(U)) has no setindex method. This type is read only.")
    end

    #=
    function Base.getindex(U::Shifted_Gaugefields_2D{NC,false},i1,i2,i3,i4,i5,i6) where NC
    #function Base.getindex(U::Shifted_Gaugefields{T,4},i1,i2,i3,i4,i5,i6) where T <: Gaugefields_2D_wing
        return U.parent.U[i1,i2,i3 .+ U.parent.NDW .+ U.shift[1],i4 .+ U.parent.NDW .+ U.shift[2],i5 .+ U.parent.NDW .+ U.shift[3],i6 .+ U.parent.NDW .+ U.shift[2]]
    end
    =#

    @inline function Base.getindex(U::Shifted_Gaugefields_2D{NC,false},i1,i2,i3,i6) where NC
        #function Base.getindex(U::Shifted_Gaugefields{T,4},i1,i2,i3,i4,i5,i6) where T <: Gaugefields_2D_wing
        @inbounds return U.parent[i1,i2,i3 .+ U.shift[1],i6 .+ U.shift[2]]
    end

    @inline function Base.getindex(U::Shifted_Gaugefields_2D{NC,true},i1,i2,i3,i6) where NC
        i3_new = i3 + U.shift[1]
        ...
        #function Base.getindex(U::Shifted_Gaugefields{T,4},i1,i2,i3,i4,i5,i6) where T <: Gaugefields_2D_wing
        @inbounds return U.parent[i1,i2,i3_new,i6_new ]
    end
    
    #=

    function Base.getindex(U::Adjoint_Gaugefields{Shifted_Gaugefields_2D{NC,false}},i1,i2,i3,i4,i5,i6) where NC
    #function Base.getindex(U::Adjoint_Gaugefields{Shifted_Gaugefields{T,4}},i1,i2,i3,i4,i5,i6) where T <: Gaugefields_2D_wing
        return conj(U.parent[i2,i1,i3,i4,i5,i6])
    end

    function Base.setindex!(U::Adjoint_Gaugefields{Shifted_Gaugefields_2D{T}},v,i1,i2,i3,i4,i5,i6)  where T <: Gaugefields_2D_wing
        error("type $(typeof(U)) has no setindex method. This type is read only.")
    end
    ...
    function Base.getindex(u::Staggered_Gaugefields{T,μ},i1,i2,i3,i6) where {T <: Gaugefields_2D_wing,μ}
        NT = u.parent.NT
        #NZ = u.parent.NZ
        #NY = u.parent.NY
        NX = u.parent.NX
    ...
    function Base.getindex(u::Staggered_Gaugefields{T,μ},i1,i2,i3,i6) where {T <: Shifted_Gaugefields_2D,μ}
        NT = u.parent.NT
        #NZ = u.parent.NZ
        #NY = u.parent.NY
        NX = u.parent.NX
    ...
    function map_U!(U::Gaugefields_2D_wing{NC},f!::Function,V::Gaugefields_2D_wing{NC},iseven::Bool) where {NC} 
        NT = U.NT
        #NZ = U.NZ
        #NY = U.NY
        NX = U.NX
    ...
    function map_U_sequential!(U::Gaugefields_2D_wing{NC},f!::Function,Uin) where {NC} 
        NT = U.NT
        #NZ = U.NZ
        #NY = U.NY
        NX = U.NX
    ...
    function clear_U!(Uμ::Gaugefields_2D_wing{NC}) where NC
        NT = Uμ.NT
        #NZ = Uμ.NZ
        #NY = Uμ.NY
        NX = Uμ.NX
    ...
    function clear_U!(Uμ::Gaugefields_2D_wing{NC},iseven::Bool) where NC
        NT = Uμ.NT
        #NZ = Uμ.NZ
        #NY = Uμ.NY
        NX = Uμ.NX
    ...
    function unit_U!(Uμ::Gaugefields_2D_wing{NC}) where NC
        NT = Uμ.NT
        #NZ = Uμ.NZ
        #NY = Uμ.NY
        NX = Uμ.NX
    ...
    Λ = TA(M)
    """
    function construct_Λmatrix_forSTOUT!(Λ,δ_current::Gaugefields_2D_wing{NC},Q,u::Gaugefields_2D_wing{NC}) where NC
        NT = u.NT
        #NY = u.NY
        #NZ = u.NZ
        NX = u.NX
    ...
    function set_wing_U!(u::Array{Gaugefields_2D_wing{NC},1}) where NC
        for μ=1:2
            set_wing_U!(u[μ]) 
        end
    end
    ...
    function set_wing_U!(u::Gaugefields_2D_wing{NC}) where NC
        NT = u.NT
        #NY = u.NY
        #NZ = u.NZ
        NX = u.NX
            ...
            #for iz=1:NZ
                #for iy=1:NY
                    for id=1:NDW
                        for k2=1:NC
                            @simd for k1=1:NC
                                @inbounds u[k1,k2,-NDW+id, it] = u[k1,k2,NX+(id-NDW), it]
                            end
                        end
                    end
                #end
            ...
            #for iz=1:NZ
                #for iy=1:NY
                    for id=1:NDW
                        for k2=1:NC
                            @simd for k1=1:NC
                                @inbounds u[k1,k2,NX+id, it] = u[k1,k2,id, it]
                            end
                        end
                    end
                #end
            ...
            #for iz=-NDW+1:NZ+NDW
                #for iy=-NDW+1:NY+NDW
                    for ix=-NDW+1:NX+NDW
                        for k1=1:NC
                            @simd for k2=1:NC
                                @inbounds u[k1,k2,ix, id-NDW] = u[k1,k2,ix, NT+(id-NDW)]
                                @inbounds u[k1,k2,ix, NT+id] = u[k1,k2,ix, id]
                            end
                        end
                    end
                #end
    ...
    function exptU!(uout::T,t::N,u::Gaugefields_2D_wing{NC},temps::Array{T,1}) where {N <: Number, T <: Gaugefields_2D_wing, NC} #uout = exp(t*u)
    ...
    # #=
    function exptU!(uout::T,t::N,v::Gaugefields_2D_wing{3},temps::Array{T,1}) where {N <: Number, T <: Gaugefields_2D_wing} #uout = exp(t*u)
        ww = temps[1]
        w = temps[2]
...
-----------------------------------------------------c
    ...
    function Traceless_antihermitian!(vout::Gaugefields_2D_wing{3},vin::Gaugefields_2D_wing{3}) 
    ...
    function Traceless_antihermitian!(vout::Gaugefields_2D_wing{2},vin::Gaugefields_2D_wing{2})
        #error("Traceless_antihermitian! is not implemented in type $(typeof(vout)) ")
        fac13 = 1/3
        NX = vin.NX
        #NY = vin.NY
    ...
    function LinearAlgebra.tr(a::Gaugefields_2D_wing{NC},b::Gaugefields_2D_wing{NC}) where NC
        NX=a.NX
        #NY=a.NY
        #NZ=a.NZ
        NT=a.NT
    ...
    function LinearAlgebra.tr(a::Gaugefields_2D_wing{2},b::Gaugefields_2D_wing{2})
        NX=a.NX
        #NY=a.NY
        #NZ=a.NZ
        NT=a.NT
    ...
    function LinearAlgebra.tr(a::Gaugefields_2D_wing{3},b::Gaugefields_2D_wing{3}) 
        NX=a.NX
        #NY=a.NY
        #NZ=a.NZ
        NT=a.NT
    ...
    function LinearAlgebra.tr(a::Gaugefields_2D_wing{NC}) where NC
        NX=a.NX
        #NY=a.NY
        #NZ=a.NZ
        NT=a.NT
    ...
    function add_U!(c::Gaugefields_2D_wing{NC},a::T1) where {NC,T1 <: Abstractfields}
    ...
    function add_U!(c::Gaugefields_2D_wing{NC},a::T1,iseven::Bool) where {NC,T1 <: Abstractfields}
        NT = c.NT
        #NZ = c.NZ
        #NY = c.NY
        NX = c.NX
    ...
    function add_U!(c::Gaugefields_2D_wing{NC},α::N,a::T1) where {NC,T1 <: Abstractfields, N<:Number}
        #@inbounds for i=1:length(c.U)
        #    c.U[i] += α*a.U[i]
        #end
        #return 
    ...
    function LinearAlgebra.mul!(c::Gaugefields_2D_wing{NC},a::T1,b::T2) where {NC,T1 <: Abstractfields,T2 <: Abstractfields}
        @assert NC != 2 && NC != 3 "This function is for NC != 2,3"
        NT = c.NT
        #NZ = c.NZ
        #NY = c.NY
...
=#
    ...
    function LinearAlgebra.mul!(c::Gaugefields_2D_wing{2},a::T1,b::T2,iseven::Bool) where {T1 <: Abstractfields,T2 <: Abstractfields}
        NT = c.NT
        #NZ = c.NZ
        #NY = c.NY
        NX = c.NX
    ...
    function LinearAlgebra.mul!(c::Gaugefields_2D_wing{2},a::T1,b::T2) where {T1 <: Abstractfields,T2 <: Abstractfields}
        NT = c.NT
        #NZ = c.NZ
        #NY = c.NY
        NX = c.NX
    ...
    function LinearAlgebra.mul!(c::Gaugefields_2D_wing{2},a::T1,b::T2,α::Ta,β::Tb) where {NC,T1 <: Abstractfields,T2 <: Abstractfields,Ta <: Number, Tb <: Number}
        NT = c.NT
        #NZ = c.NZ
        #NY = c.NY
        NX = c.NX
    ...
    function LinearAlgebra.mul!(c::Gaugefields_2D_wing{3},a::T1,b::T2) where {T1 <: Abstractfields,T2 <: Abstractfields}
        NT = c.NT
        #NZ = c.NZ
        #NY = c.NY
        NX = c.NX
    ...
    function LinearAlgebra.mul!(c::Gaugefields_2D_wing{3},a::T1,b::T2,α::Ta,β::Tb) where {NC,T1 <: Abstractfields,T2 <: Abstractfields,Ta <: Number, Tb <: Number}
        NT = c.NT
        #NZ = c.NZ
        #NY = c.NY
        NX = c.NX
    ...
    function staggered_phase(μ,ix,it,NX,NT)
        t = it-1
        t += ifelse(t<0,NT,0)
        t += ifelse(t ≥ NT,-NT,0)
        #boundary_factor_t = ifelse(t == NT -1,BoundaryCondition[4],1)
    ...
    function normalize_U!(u::Gaugefields_2D_wing{NC}) where NC
        NX = u.NX
        #NY = u.NY
        #NZ = u.NZ
        NT = u.NT
    ...
    function normalize_U!(u::Gaugefields_2D_wing{2}) 
        NX = u.NX
        #NY = u.NY
        #NZ = u.NZ
        NT = u.NT
    ...
    function normalize_U!(u::Gaugefields_2D_wing{3}) 
        NX = u.NX
        #NY = u.NY
        #NZ = u.NZ
        NT = u.NT
    ...
    function m3complv!(a::Gaugefields_2D_wing{3})
        aa = zeros(Float64,18)
        NX = a.NX
        #NY = a.NY
        #NZ = a.NZ
