...
function LinearAlgebra.mul!(
    c::Gaugefields_4D_accelerator{3,TU,TUv,:cuda},
    A::T1,
    B::T2) where {T1<:Gaugefields_4D_accelerator,T2<:Gaugefields_4D_accelerator,TU<:CUDA.CuArray,TUv}
    CUDA.@sync begin
...
function LinearAlgebra.mul!(
    c::Gaugefields_4D_accelerator{3,TU,TUv,:cuda},
    A::T1,
    B::Adjoint_Gaugefields{T2}) where {T1<:Gaugefields_4D_accelerator,T2<:Gaugefields_4D_accelerator,TU<:CUDA.CuArray,TUv}
    CUDA.@sync begin
...
function LinearAlgebra.mul!(
    c::Gaugefields_4D_accelerator{3,TU,TUv,:cuda,TshiftedU},
    A::T1,
    B::T2
) where {T1<:Gaugefields_4D_accelerator,T2<:Shifted_Gaugefields_4D_accelerator,
...
function LinearAlgebra.mul!(
    ...
    α::Ta,
    β::Tb
) where {T1<:Shifted_Gaugefields_4D_accelerator,T2<:Shifted_Gaugefields_4D_accelerator,Ta<:Number,Tb<:Number,TU<:CUDA.CuArray,TUv,TS}
...
function LinearAlgebra.mul!(
    ...
    α::Ta,
    β::Tb
) where {T1<:Gaugefields_4D_accelerator,T2<:Shifted_Gaugefields_4D_accelerator,Ta<:Number,Tb<:Number,TU<:CUDA.CuArray,TUv,TS<:Nothing}
    CUDA.@sync begin
...
function LinearAlgebra.mul!(
    ...
    α::Ta,
    β::Tb
) where {T1<:Gaugefields_4D_accelerator,T2<:Shifted_Gaugefields_4D_accelerator,Ta<:Number,Tb<:Number,TU<:CUDA.CuArray,TUv,TS}
...
function LinearAlgebra.mul!(
    ...
    α::Ta,
    β::Tb
) where {T1<:Shifted_Gaugefields_4D_accelerator,T2<:Gaugefields_4D_accelerator,Ta<:Number,Tb<:Number,TU<:CUDA.CuArray,TUv,TS<:Nothing}
...
function LinearAlgebra.mul!(
    ...
    α::Ta,
    β::Tb
) where {T1<:Shifted_Gaugefields_4D_accelerator,T2<:Gaugefields_4D_accelerator,Ta<:Number,Tb<:Number,TU<:CUDA.CuArray,TUv,TS}
...
function LinearAlgebra.mul!(
    ...
    A::Adjoint_Gaugefields{T1},
    B::Adjoint_Gaugefields{T2}
) where {T1<:Shifted_Gaugefields_4D_accelerator,T2<:Gaugefields_4D_accelerator,TU<:CUDA.CuArray,TUv,TS}
...
function LinearAlgebra.mul!(
    ...
    α::Ta,
    β::Tb
) where {T1<:Shifted_Gaugefields_4D_accelerator,T2<:Shifted_Gaugefields_4D_accelerator,Ta<:Number,Tb<:Number,TU<:CUDA.CuArray,TUv,TS<:Nothing}
    CUDA.@sync begin
...
function LinearAlgebra.mul!(
    ...
    A::Adjoint_Gaugefields{T1},
    B::Adjoint_Gaugefields{T2}
) where {T1<:Shifted_Gaugefields_4D_accelerator,T2<:Shifted_Gaugefields_4D_accelerator,TU<:CUDA.CuArray,TUv,TS}
